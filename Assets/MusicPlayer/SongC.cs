...
public class SongC : MonoBehaviour
{
    ...
    public float delayTime = 2f; // time delay
    public AudioClip[] songClip; // audio
    ...
    private IEnumerator PlayDelayedSong()
    {
        ...
        audioSource.clip = songClip[UnityEngine.Random.Range(0, songClip.Length)];
    ...
    void Update()
    {
        if (delayPassed == true)
        {
            ...
            if (preProcessSamples)
            {
                ...
                //spawnPoint.MakePoints(plotCo.peakPoint.transform);
            }
        }
    }
